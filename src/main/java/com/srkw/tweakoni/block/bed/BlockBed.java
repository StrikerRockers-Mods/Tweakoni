package com.srkw.tweakoni.block.bed;
...
public class BlockBed extends BlockHorizontal implements ITileEntityProvider {
    ...
    {
        return state.getValue(PART) == BlockBed.EnumPartType.FOOT ? Items.AIR : ItemInit.BED;
    }
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune)
    {
        if (state.getValue(PART) == BlockBed.EnumPartType.HEAD)
        {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(ItemInit.BED, 1, enumdyecolor.getMetadata()));
        }
    }
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        EnumDyeColor enumdyecolor = tileentity instanceof TileEntityBed ? ((TileEntityBed)tileentity).getColor() : EnumDyeColor.RED;
        return new ItemStack(ItemInit.BED, 1, enumdyecolor.getMetadata());
    }
