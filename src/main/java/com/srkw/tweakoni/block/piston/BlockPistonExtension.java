...
public class BlockPistonExtension extends BlockDirectional {
	 ...
	 public static final PropertyEnum<BlockPistonExtension.PistonType> TYPE = PropertyEnum.<BlockPistonExtension.PistonType>create("type", BlockPistonExtension.PistonType.class);
	    ...
	    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
	    {
	        ...
	        if ((iblockstate.getBlock() == BlockInit.PISTON || iblockstate.getBlock() == BlockInit.STICKY_PISTON) && ((Boolean)iblockstate.getValue(BlockPistonBase.EXTENDED)).booleanValue())
	        {
	    ...
	    public static enum PistonType implements IStringSerializable
	    {
	        DEFAULT("normal"),
	        STICKY("sticky");
