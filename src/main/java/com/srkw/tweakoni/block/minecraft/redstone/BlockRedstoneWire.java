...
public class BlockRedstoneWire extends Block {
    ...
    public BlockRedstoneWire(String name, Material materialIn) {
        super(materialIn);
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        return worldIn.getBlockState(pos.down()).isTopSolid() ||
                ...
                worldIn.getBlockState(pos.down()).getBlock() == Blocks.SEA_LANTERN ||
                worldIn.getBlockState(pos.down()).getBlock() == BlockInit.PISTON ||
                worldIn.getBlockState(pos.down()).getBlock() == BlockInit.STICKY_PISTON ||
                worldIn.getBlockState(pos.down()).getBlock() == BlockInit.PISTON_EXTENSION;
    }
    ...
    /**
     * TODO public Item getItemDropped(IBlockState state, Random rand, int fortune)
     * {
     * return ItemInit.REDSTONE;
     * }
     */
